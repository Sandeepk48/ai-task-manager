    ...
    <div className="w-full max-w-md">
      <div className="rounded-2xl border border-zinc-200 bg-white p-8 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
        ...
        <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
          Access your AI Task Manager dashboard.
        </p>
        <form className="mt-8 space-y-4" onSubmit={onSubmit} aria-busy={loading}>
          ...
          <div className="space-y-2">
            <label className="text-sm font-medium text-zinc-800 dark:text-zinc-200" htmlFor="login-email">
              Email
            </label>
            <input
              id="login-email"
          ...
          <div className="space-y-2">
            <label className="text-sm font-medium text-zinc-800 dark:text-zinc-200" htmlFor="login-password">
              Password
            </label>
            <input
              id="login-password"
